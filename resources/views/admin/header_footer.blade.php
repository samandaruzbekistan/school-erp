    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item @yield('applicants')">
                    <a class="sidebar-link" href="{{ route('applicants') }}">
                        ...
                        <span class="align-middle">Talabgorlar</span>
                    </a>
                </li>
                <li class="sidebar-item @yield('subjects')">
                    <a class="sidebar-link" href="{{ route('classes') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <span class="align-middle">Sinflar</span>
                    </a>
                </li>
